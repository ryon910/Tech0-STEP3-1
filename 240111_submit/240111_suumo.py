...
df['access1_walk'] = pd.to_numeric(df['access1_walk'], errors='coerce').fillna(10).astype(int)
df['access2_walk'] = pd.to_numeric(df['access2_walk'], errors='coerce').fillna(10).astype(int)
df['access3_walk'] = pd.to_numeric(df['access3_walk'], errors='coerce').fillna(10).astype(int)
